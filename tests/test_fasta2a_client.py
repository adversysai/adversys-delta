...
def print_troubleshooting():
    ...
    print("   - Make sure Delta is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Delta server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Delta server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Delta server if not running")
