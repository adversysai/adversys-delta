...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by Delta",
            "type": "select",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by Delta",
    ...
    embed_model_section: SettingsSection = {
        ...
        "description": f"Settings for the embedding model used by Delta.<br><h4>⚠️ No need to change</h4>The default HuggingFace model {default_settings['embed_model_name']} is preloaded and runs locally within the docker container and there's no need to change it unless you have a specific requirements for embedding.",
    ...
    browser_model_section: SettingsSection = {
        ...
        "description": "Settings for the web browser model. Delta uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> agentic framework to handle web interactions.",
    ...
    auth_section: SettingsSection = {
        ...
        "description": "Settings for authentication to use Delta Web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    memory_fields.append(
        {
            ...
            "description": "Delta will automatically recall memories based on convesation context.",
            "type": "switch",
    ...
    mcp_client_section: SettingsSection = {
        ...
        "description": "Delta can use external MCP servers, local or remote as tools.",
   ...
   # Secrets section
    ...
    external_api_fields.append(
        {
            ...
            "title": "API Examples",
            "description": "View examples for using Delta's external API endpoints with API key authentication.",
            "type": "button",
    ...
    external_api_section: SettingsSection = {
        "id": "external_api",
        "title": "External API",
        "description": "Delta provides external API endpoints for integration with other applications. "
    ...
    update_checker_fields.append(
        {
            ...
            "description": "Enable update checker to notify about newer versions of Delta.",
            "type": "switch",
    ...
    backup_section: SettingsSection = {
        ...
        "description": "Backup and restore Delta data and configurations "
...
def _adjust_to_version(settings: Settings, default: Settings):
    # starting with 0.9, the default prompt subfolder for agent no. 0 is Delta
    # switch to Delta if the old default is used from v0.8
...
def get_default_settings() -> Settings:
    return Settings(
        ...
        chat_model_name="meta-llama/llama-3.3-70b-instruct:free",
        chat_model_api_base="",
        chat_model_kwargs={},
        chat_model_ctx_length=131072,
        ...
        util_model_name="meta-llama/llama-3.3-70b-instruct:free",
        util_model_api_base="",
        ...
        browser_model_name="meta-llama/llama-3.3-70b-instruct:free",
